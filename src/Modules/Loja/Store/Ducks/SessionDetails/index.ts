...
export type SessionActions = LoadSessionDetails | LoadSessionDetailsSuccess | LoadSessionDetailsFailure;
...
export default function reducer(state = initialState, action: SessionActions): SessionDetailsState {
  switch (action.type) {
...
export function loadSessionDetails(data: LoadSessionDetailsRequest): LoadSessionDetails {
  return {
